...
function Page({ params }: { params: { productId: string } }) {
  ...
  const isProductInCart = (product: ProductInfo) => {
  ...
  return (
    <div className='grid grid-cols-1 '>
      <div className='fixed top-0 left-0 right-0'>
        ...
        <ul className="flex items-center space-x-2 text-gray-600 mt-2 mx-2">
          <li><a href="/homepage" className="text-gray-800 hover:text-blue-500">Home{'>'}</a></li>
          <li><a href="/homepage" className="text-gray-800 hover:text-blue-500">Shop{'>'}</a></li>
